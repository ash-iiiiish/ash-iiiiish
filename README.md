...
**AI/ML Engineer · GenAI & Agentic Systems Builder · India**
...
Final-year CS undergrad (B.Tech) building **LLM-powered agentic systems, RAG pipelines, and computer vision products** end-to-end — from dataset curation to production deployment.

- 🔭 &nbsp;Currently building **LangGraph-based agentic workflows** and **enterprise RAG systems** with MCP-based tool integration
- 🧠 &nbsp;Shipped an enterprise LLM copilot, a multimodal RAG assistant, and two deep learning systems at **98–99% accuracy**
...
![MCP](https://img.shields.io/badge/MCP%20Tooling-000000?style=flat&logoColor=white)
...
![PaddleOCR](https://img.shields.io/badge/PaddleOCR-5C3EE8?style=flat&logoColor=white)
...
![FastMCP](https://img.shields.io/badge/FastMCP-009688?style=flat&logoColor=white)
